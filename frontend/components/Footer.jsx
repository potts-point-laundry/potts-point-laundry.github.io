				...
				<Container className="p-3">
					...
					<Row>
						<Col lg={10} className="p-0">
							<Col sm={12}>
								<h4>Potts Point Laundry & Dry Cleaning</h4>
							</Col>
							<Col sm={12}>
								<p className="m-0">
									<LocationOnIcon />{" "}
									...
									>
										{storeDetails
											...
											: "138 Victoria Street, Potts Point NSW2011"}
									</a>
								</p>
							</Col>
							<Col sm={12}>
							...
							<Col sm={12}>
								<p className="m-0">
									<AccessTimeIcon />{" "}
									{storeDetails
										? storeDetails.business_hour
										: "Monday - Friday: 7am - 9pm | Last Wash 8pm"}
								</p>
							</Col>
							<Col sm={12}>
								<p className="m-0">
									<AccessTimeIcon />{" "}
									{storeDetails
										? storeDetails.business_hour2
										: "Saturday - Sunday: 8am - 9pm | Last Wash 8pm"}
								</p>
							</Col>
						</Col>
