											...
											return (
												<TableRow key={i}>
													<TableCell component="th" scope="row">
														{each.name} <br />{" "}
														<span className="text-muted">{each.description}</span>
													</TableCell>
					...
					<Col md={4} className="mb-4">
						...
						<TableContainer component={Paper}>
							<Table size="small" aria-label="Laundry Service Table">
								<TableBody>
									<TableRow>
										<TableCell align="center" colSpan={2} className="bg-dark text-light">
									...
									<TableRow>
										<TableCell align="center" colSpan={2} className="bg-secondary text-light">
